...
import { FaWallet, FaPaperPlane, FaLink, FaUtensils, FaMoneyBillWave, FaCoffee, FaBook, FaInfoCircle } from 'react-icons/fa'; // Import icons

// Sample data for weekly spending chart (from screenshot: Mon 220, Tue 165, Wed 110, Thu 55, Fri-Sun 0)
const spendingData = [
  { day: 'Mon', amount: 220 },
  { day: 'Tue', amount: 165 },
  { day: 'Wed', amount: 110 },
...
// Sample transactions (updated with current date Oct 15, 2025 for latest entry)
const transactions = [
...
const Dashboard = () => {
  const handleConnectWallet = () => {
    // Placeholder for wallet connection logic (e.g., integrate with MetaMask)
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="action-buttons-wrapper">
        ...
        <button className="action-button secondary-button" onClick={handleConnectWallet}>
